...
<?php
	...
	$edit=new DbMysql();	
	$result=$edit->select("select * from productList where id=$id",1);
...
<html>
	...
	<!---->
	        <table width="98%" align="center">
	          <tr>
	            <td class="bgtext">当前位置：修改商品分类</td>
	          </tr>
	          <tr>
	            <td height="20">
	          ...
	          <tr>
	            <td>
	            <table width="100%" >
				<form name="admin" id="admin" method="POST" action="productList_editSava.php?id=<?php echo $id; ?>" onsubmit="return test();">
	            <tr>
