...
<body>
<form name="admin" id="admin" method="POST" action="ProductMng_editSava.php?id=<?php echo $id;?>" onsubmit="return test();">
<table width="100%">
	<tr>
	 ...
	 <tr>
	    ...
	    <td valign="top" bgcolor="#F7F8F9">
	       <div>
	          ...
	          <tr><td class="bgtext">当前位置：修改商品</td></tr>	            	          
	          <tr>
	            <td height="20">
	          ...
	          <tr>
	            ...
	            <table width="100%">
	              ...
	              <tr style="background: #f2f2f2;">
	                ...
	                <td width="1%">&nbsp;</td>
	                <td width="32%" height="30" >
	                	<input name="title" type="text" id="title" size="30" value="<?php 	echo $title; ?>"/>
	                </td>
	             ...
	             <tr style="background: #f2f2f2;">
	                ...
	                <td width="32%" height="30" >
	                   <input name="hot" type="checkbox" value="1"
	                   	<?php
	                   		if($hot == 1){echo "checked";}	
	                   	?>>热销	                   
	                   <input name="drop" type="checkbox" value="1"
	                   	<?php
	                   		if($drops == 1){echo "checked";}           		
	                   	?>>降价
	              ...
	              <tr style="background: #f2f2f2;">
	                ...
	                <td>&nbsp;</td>
	                <td width="32%" height="30" >
	                	<input name="kucun" type="text" id="kucun" size="30" value="<?php echo $kucun; ?>"/></td>
	              ...
	              <tr style="background: #f2f2f2;">
	                ...
	                <td >&nbsp;</td>
	                <td width="32%" height="30">
	                	<input name="hits" type="text" id="hits"  size="30" value="<?php echo $hits;?>"/>
	                </td>
	              ...
	              <tr style="background: #f2f2f2;">
	                ...
	                <td >&nbsp;</td>
	                <td width="32%" height="30">
	                	<input name="yprice" type="text" id="yprice" value="<?php echo $yprice;?>" size="30" />
	                </td>
	              ...
	              <tr style="background: #f2f2f2;">
	                ...
	                <td >&nbsp;</td>
	                <td width="32%" height="30">
	                	<input name="price" type="text" id="price" value="<?php echo $price;?>" size="30" />
	                </td>
	                <td width="45%" height="30" class="bgtext"></td>
	              </tr>
	              <tr style="background: #f2f2f2;">
	                ...
	                <td width="1%">&nbsp;</td>
	                <td width="32%" height="30">
	                	<input type="text" value="<?php echo $picurl; ?>" id="picurl" style="width:280px;" name="picurl"/>
	                </td>
	              ...
	              <tr style="background: #f2f2f2;">
					<td height="30" align="right">已有图集：</td>
					<td bgcolor="#f2f2f2">&nbsp;</td>
              ...
              <tr style="background: #f2f2f2;">
                ...
                <td height="30" colspan="2" > 
                  <textarea name="content" id="content" cols="45" rows="5" class="ckeditor"><?php echo $content; ?></textarea>
                </td>
             </tr>
              <tr style="background: #f2f2f2;">
