...
<?php
	...
	$db= new DbMysql();	
	$result=$db->select("select max(typeorder) as typeorder from feedbackType ",1);	
	...
	<table width="100%">
	  ...
	  <tr>
	    ...
	    <td valign="top" bgcolor="#F7F8F9">
	       <div>
	        <table width="98%">
	          <tr><td class="bgtext">当前位置：添加留言分类</td></tr> <tr>
	            <td height="20">
	          ...
	          <tr>
	            <td>
	            <table width="100%">
				<form name="admin" id="admin" method="POST" action="feedbackType_addSava.php" onsubmit="return test();">
	              ...
	              <tr style="background:#f2f2f2 ;">
	                ...
	                <td width="3%">&nbsp;</td>
	                <td width="32%" height="30">
	                  <input name="typezt" type="radio" id="radio" value="1" checked="checked" />
	                  <label for="typezt">开启 
	                    <input type="radio" name="typezt" id="radio2" value="0" />
	                  </label> 关闭
	                </td>
