	  ...
	  <tr>
	    ...
	    <td valign="top" bgcolor="#F7F8F9">
	       <div>
	          ...
	          <tr><td class="bgtext">当前位置：修改新留言</td></tr>
	          <tr>
	            <td height="20">
	          ...
	          <tr>
				...
				<form name="admin" id="admin" method="POST" action="feedback_editSava.php" onsubmit="return test();">
	              ...
	              <tr style="background:#f2f2f2 ;">
	                ...
	                <td>&nbsp;</td>
	                <td width="32%" height="30">
	                	<input type="radio" name="ishf" id="radio3" value="0" <?php if($ishf==0) echo "checked";?> />待回复 
	              ...
	              <tr style="background:#f2f2f2 ;">
	               ...
	               <tr style="background:#f2f2f2 ;">
	                ...
	                <td>&nbsp;</td>
	                <td width="32%" height="30">
	                	<input name="usernameshow" type="text" id="usernameshow" size="30" value='<?php echo $usernameshow;?>'/></td>
