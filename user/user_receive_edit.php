...
<html>
	...
	<form action="user_receiveSava.php" method="post" name="form_add_consignee" id="fromadd">
		<header>
			...
			<p style="display: inline-block;">修改信息</p>
		...
		<div class="container">
			...
			<ul class="row" style="margin-top: 18px;">
				...
				<li class="col-xs-12 rem">
					<span ><input type="hidden" name="id" value="<?php echo $id;?>" /><input type="hidden" name="action" value="edit" />收货人&nbsp;&nbsp;</span>
					<input name="shren" value='<?php echo $info["shren"];?>' type="text" id="shren" placeholder=" 请输入收货人真实姓名">
				</li>
				<li class="col-xs-12 rem">
					<span >手机号&nbsp;</span>
					<input name="mobile" size="20" type="text" id="mobile" value='<?php echo $info["mobile"];?>' placeholder=" 请输入收货人手机号">
				</li>
				<li class="col-xs-12 rem">
					<span>收货地址&nbsp;</span>
					<span class="render_province"></span> <span class="render_city"></span> <span class="render_district"></span>
					<input name="shdizhi" type="text" id="shdizhi" value='<?php echo $info["shdizhi"];?>' placeholder=" 请输入收货人地址">
				</li>
				<li class="col-xs-12 rem" style="margin-top: 16px;">
					<span >邮编&nbsp;&nbsp; </span>
					<input value='<?php echo $info["youbian"];?>' name="youbian" size="10" type="text" id="youbian" >
				</li>
				<li class="col-xs-12 rem">
					<span>固定电话&nbsp;</span>
					<input value="<?php echo $info["tel"];?>" name="tel" size="20" type="text" id="tel" >
				</li>
			</ul>
		</div>
		</form>
